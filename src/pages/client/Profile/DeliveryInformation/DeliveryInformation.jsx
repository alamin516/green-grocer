  ...
  return (
    <>
      <SEO
        ...
        description="Green grocer is the biggest organic online platform for people Delivery Information"
        keywords={[]}
        image=""
        url=""
      />

      <Breadcrumbs pageTitle="Delivery Information" />
      ...
      <div className="w-full mb-10">
        <div className="w-full lg:w-[66%] mx-auto px-[15px]">
          ...
          <div className="main-content px-[15px] whitespace-pre-wrap">
            <p className="my-5">Delivery Information</p>
          </div>
        </div>
      </div>
    </>
