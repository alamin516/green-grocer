...
const Support = () => {
  return (
    <>
      <SEO
        title="Support"
        description="Green grocer is the biggest organic online platform for people Support"
        keywords={[]}
        image=""
        url=""
      />

      <Breadcrumbs pageTitle="Support" />
        ...
        <div className="w-full lg:w-[66%] mx-auto px-[15px]">
          ...
          <div>
            <h1 className="page_heading lg:text-[22px] text-lg text-[#222] leading-[34px] font-bold py-1.5 tracking-[0.8] capitalize relative mb-[15px]">
              <span className="relative bg-white z-[2] pr-[25px]">Support</span>
