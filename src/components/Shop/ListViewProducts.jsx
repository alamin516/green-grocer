          ...
          {filteredProducts.map((product, i) => {
            ...
            return (
              <>
                <div
                  key={i}
                  className="w-full product-card border border-[#e5e5e5] bg-white overflow-hidden group transition-all duration-500 ease-in-out flex items-center justify-between"
                >
